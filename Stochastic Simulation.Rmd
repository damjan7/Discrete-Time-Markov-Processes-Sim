...
eigen((Transition_Matrix1))
ev1 <- eigen((Transition_Matrix1))$vectors[,1]
t(ev1/sum(ev1)) %*% Transition_Matrix1
t(ev1/sum(ev1)) %*% matrix.power(Transition_Matrix1,100)
...
abs(t(ev1) %*% Stationary_MAT) / sum(abs(t(ev1) %*% Stationary_MAT))
ev1
